...
//        Card.printDeck(deck);
        ...
        Card.printDeck(cards, "Cards Collection with Kings copied", 1);
...
//        Collections.shuffle(deck);
        ...
        System.out.println("sublist in dex of tens = " + sublistIndex);
        ...
        if (Collections.replaceAll(deck, tenOfHearts, tenOfClubs)) {
            ...
            System.out.println("No tens fo harts found in the list");
        }
