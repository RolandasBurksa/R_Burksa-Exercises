...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("---> Remove names where firs = last");
    ...
    // Tas pats kas virsui perresant per lambda
//    BiFunction<Character, Character, Character> getRandomChar =
//            (startChar, endChar) -> (char) random.nextInt((int) startChar, (int) endChar + 1);
