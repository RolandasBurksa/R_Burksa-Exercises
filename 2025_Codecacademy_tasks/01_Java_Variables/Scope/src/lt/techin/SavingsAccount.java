...
//    public double addMoney(double balanceDollar){
//        // Complete this method
//        System.out.println("Adding " + balanceDollar + " dollars to the account." );
//        double currentBalance = this.balanceDollar += balanceDollar;
//        System.out.println("The new balance is " + currentBalance + " dollars." );
